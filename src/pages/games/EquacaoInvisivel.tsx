...
export default function EquacaoInvisivel() {
  ...
  function verificarResposta(opcao: number) {
  ...
  function mostrarPopupConquista(tipo: React.SetStateAction<string | null>) {
        ...
        <header className="header-equacao">
          <div className="header-content">
            <div className="lado-esq-equacao">
              <button onClick={() => (window.location.href = "/GamesScreen")}>⮜</button>
